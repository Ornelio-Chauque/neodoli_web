...
express()
  ...
  .post("/dashboard/:id/response/:responseId/medicine", bodyParse.urlencoded({extended:true}),(req, res)=>{
    db.db.none('INSERT INTO medicines(name, available, "madeIn", "responseId") VALUES($1, $2, $3, $4)', [req.body.name,req.body.available, req.body.madeIn, req.params.prescriptionId ])
    .then(data=>{
