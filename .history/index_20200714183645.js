...
express()
  ...
  .get('/dashboard',(req, res)=>{res.render('pages/index')})
  .get('/dashboard/addPharmacy', (req, res)=>{res.render('pages/index')
  .get('/dashboard/addMedine', (req, res)=>{res.render('pages/index', {pharmacy:"Farmacia Maria Luisa", address:"Beira, Macuti"})})
